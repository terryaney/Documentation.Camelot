...
[`BTRAnnBuckDebug`](RBLeFinancial.BTRAnnBuckDebug.md) | A replacement function for the Annbuck.xla!AnnBuck() function.  Returns a decimal value representing the selected life annuity factor.
...
[`BTRAnnualReturnDebug`](RBLeFinancial.BTRAnnualReturnDebug.md) | DOC: Han, Cfgena replacement?  Returns plan investment annual return based on Fund allocations and how Funds are mapped to assets classes.
...
[`BTRAssetClassAllocationDebug`](RBLeFinancial.BTRAssetClassAllocationDebug.md) | DOC: Han, Cfgena replacement?  Returns plan asset class allocation based on Fund allocations and how Funds are mapped to assets classes.
...
[`BTRCalculateLoanDebug`](RBLeFinancial.BTRCalculateLoanDebug.md) | DOC: Han, Cfgena replacement?  Returns an array with 3 values: balance at EOY, principle payments with investment return at EOY and principle payments with investment return at EOB.
...
[`BTRGet401kContributionsDebug`](RBLeFinancial.BTRGet401kContributionsDebug.md) | DOC: Han, Cfgena replacement?  Returns 401(k) contributions/match.
[`BTRGetContributions`](RBLeFinancial.BTRGetContributions.md) | DOC: Han, Cfgena replacement?  Returns 401k contributions/match.
[`BTRGetContributionsDebug`](RBLeFinancial.BTRGetContributionsDebug.md) | DOC: Han, Cfgena replacement?  Returns 401k contributions/match.
[`BTRGetERContribution`](RBLeFinancial.BTRGetERContribution.md) | DOC: Han, Cfgena replacement?  Returns employer contributions.
[`BTRGetERContributionDebug`](RBLeFinancial.BTRGetERContributionDebug.md) | DOC: Han, Cfgena replacement?  Returns employer contributions.
...
[`BTRGetERContributionPctDebug`](RBLeFinancial.BTRGetERContributionPctDebug.md) | DOC: Han, Cfgena replacement?  Returns employer contribution % based on contribution parameters.
...
[`BTRGetMatchPctDebug`](RBLeFinancial.BTRGetMatchPctDebug.md) | DOC: Han, Cfgena replacement?  Returns employer match % based on match parameters.
...
[`BTRGetMinContributionsForMaxMatchDebug`](RBLeFinancial.BTRGetMinContributionsForMaxMatchDebug.md) | DOC: Han, Cfgena replacement?  Returns minimum employee contribution to get max mactch based on match parameters.
...
[`BTRJointLifeDebug`](RBLeFinancial.BTRJointLifeDebug.md) | Replacement function for the Cfgena.xla!JointLife() function.  Returns decimal value equal to the selected joint life annuity factor.
...
[`BTRPPAJointLifeDebug`](RBLeFinancial.BTRPPAJointLifeDebug.md) | Replacement function for the Cfgena.xla!PPAJointLife() function.  Returns a decimal value equal to the selected joint life annuity factor by the PPA method.
...
[`BTRPPASingleLifeDebug`](RBLeFinancial.BTRPPASingleLifeDebug.md) | Replacement function for the Cfgena.xla!PPASingleLife() function.  Returns a decimal value equal to the selected single life annuity factor by the PPA method.
...
[`BTRSingleLifeDebug`](RBLeFinancial.BTRSingleLifeDebug.md) | Replacement function for the Cfgena.xla!SingleLife() function.  Returns a decimal value equal to the selected single life annuity factor.
...
[`BTRSSPIADebug`](RBLeFinancial.BTRSSPIADebug.md) | A replacement function for the Cfgena.xla!SSExactPays() function using a single current pay value.  Returns a decimal value representing the age 65 Social Security monthly benefit using exact pays.
...
[`BTRTargetFundIDDebug`](RBLeFinancial.BTRTargetFundIDDebug.md) | DOC: Han, Cfgena replacement?  Returns index of Target Fund based on retirement year and target fund group.
