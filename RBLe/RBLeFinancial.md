...
[`BTRAnnBuckDebug`](RBLeFinancial.BTRAnnBuckDebug.md) | Debug version of BTRAnnBuck that returns value or exception string (instead of #VALUE on error).  A replacement function for the Annbuck.xla!AnnBuck() function.  Returns a decimal value representing the selected life annuity factor.
...
[`BTRAnnualReturnDebug`](RBLeFinancial.BTRAnnualReturnDebug.md) | Debug version of BTRAnnualReturn that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns plan investment annual return based on Fund allocations and how Funds are mapped to assets classes.
...
[`BTRGet401kContributionsDebug`](RBLeFinancial.BTRGet401kContributionsDebug.md) | Debug version of BTRGet401kContributions that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns 401(k) contributions/match.
[`BTRGetContributions`](RBLeFinancial.BTRGetContributions.md) | DOC: Han, Cfgena replacement?  Returns 401k contributions/match.
[`BTRGetContributionsDebug`](RBLeFinancial.BTRGetContributionsDebug.md) | Debug version of BTRGetContributions that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns 401k contributions/match.
[`BTRGetERContribution`](RBLeFinancial.BTRGetERContribution.md) | DOC: Han, Cfgena replacement?  Returns employer contributions.
[`BTRGetERContributionDebug`](RBLeFinancial.BTRGetERContributionDebug.md) | Debug version of BTRGetERContribution that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns employer contributions.
...
[`BTRGetERContributionPctDebug`](RBLeFinancial.BTRGetERContributionPctDebug.md) | Debug version of BTRGetERContributionPct that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns employer contribution % based on contribution parameters.
...
[`BTRGetMatchPctDebug`](RBLeFinancial.BTRGetMatchPctDebug.md) | Debug version of BTRGetMatchPct that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns employer match % based on match parameters.
...
[`BTRJointLifeDebug`](RBLeFinancial.BTRJointLifeDebug.md) | Debug version of BTRJointLife that returns value or exception string (instead of #VALUE on error).  Replacement function for the Cfgena.xla!JointLife() function.  Returns decimal value equal to the selected joint life annuity factor.
...
[`BTRSingleLifeDebug`](RBLeFinancial.BTRSingleLifeDebug.md) | Debug version of BTRSingleLife that returns value or exception string (instead of #VALUE on error).  Replacement function for the Cfgena.xla!SingleLife() function.  Returns a decimal value equal to the selected single life annuity factor.
...
[`BTRTargetFundIDDebug`](RBLeFinancial.BTRTargetFundIDDebug.md) | Debug version of BTRTargetFundID that returns value or exception string (instead of #VALUE on error).  DOC: Han, Cfgena replacement?  Returns index of Target Fund based on retirement year and target fund group.
