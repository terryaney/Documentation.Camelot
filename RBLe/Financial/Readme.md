...
[`BTRWageBase`](Financial/BTRWageBase.md) | A replacement function for the Cfgena.xla!WageBase() function.  Returns a decimal value of Social Security Wage Base at yearEvent parameter.
