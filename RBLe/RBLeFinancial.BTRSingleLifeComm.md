...
```excel
=BTRSingleLifeComm(mortTable, intRate, age, typeCF, pmtsPerYr, mortTableAdj, mortSizeAdj, mortalityImprovement, improvementEffectiveYear, memberYearOfBirth, dynamicImprovementStopYear)
```
...
`typeCF` | Object | Commutation Function (CF) type, please see CFGENA help for details.
